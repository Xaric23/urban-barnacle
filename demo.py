...
if __name__ == "__main__":
    demo_game()
=======
# Automated simulation demo leveraging the core game systems without user input.
#
# This script subclasses `ClubManager` from `game.py` and overrides the
# interaction-heavy pieces with automated heuristics so the game can run in a
# hands-free fashion. It showcases the dynamic event system, performer
# management, and economic loops while making consistent, deterministic choices
# that keep the club afloat.
